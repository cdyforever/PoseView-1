...
try:
    ...
    print(e)
    print('you need to build c++ library before use pafprocess, open pafprocess dir and use the command below\
...
class TfPoseEstimator:
    ...
    @staticmethod
    def draw_humans(npimg, humans, imgcopy=False, show_paf=False, show_heatmap=False):
        if imgcopy:
            npimg = np.copy(npimg)
