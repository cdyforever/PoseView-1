...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/media/senya/data1/dataset/COCO/annotations')
    parser.add_argument('--imgpath', type=str, default='/media/senya/data1/dataset/COCO/')
    ...
    #--checkpoints，first use pretrained，so is false, while when you train goon, use true
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.checkpoint:
            ...
            if '.ckpt' in pretrain_path:
                logger.info('Now loading the pretrained model...')
                time.sleep(5)
                loader = tf.train.Saver(net.restorable_variables())
